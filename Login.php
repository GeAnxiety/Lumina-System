		...
		<div class="row content-row">
			...
			<div class="col align-items-center flex-col">
				<div class="text sign-in">
					...
					<p>
						Light of the World Worldwide Ministries - Commonwealth
					</p>
				</div>
				<div class="img sign-in">
					<img src="assets/undraw_progress_data_re_rv4p.svg" alt="welcome">
				</div>
			</div>
			<!-- END SIGN IN CONTENT -->
			<!-- SIGN UP CONTENT -->
			<div class="col align-items-center flex-col">
				<div class="img sign-up">
					<img src="assets/undraw_lives_matter_38lv.svg" alt="welcome">
				</div>
